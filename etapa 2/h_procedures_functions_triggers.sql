...
--Vagas disponíveis em uma turma
...
-- Índice de Rendimento Acadêmico (IRA) ponderado por carga horária
...
-- Verificação de aprovação por nota e frequência
...
-- Realização de matrícula com validação de vagas e duplicidade
...
-- Teste da procedure realizar_matricula
...
--Auditoria de alterações de status da matrícula
...
-- Atualização automática de status ao lançar nota e frequência
...
-- Validação de conflito de sala e horário
